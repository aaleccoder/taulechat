...
export default function Home() {
  return (
    ...
    >
      ...
      <Button
        asChild
        className="h-12 px-6 rounded-full shadow-lg bg-gradient-to-r from-primary to-primary/70 motion-safe:transition-all motion-safe:duration-150 active:scale-95 hover:shadow-xl hover:scale-105"
