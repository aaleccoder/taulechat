...
import {
  saveOpenRouterModelsToStore,
  saveGeminiModelsToStore,
} from "./utils/store";
...
function App() {
  useEffect(() => {
    const fetchData = async () => {
      ...
      const [openRouterModelsRes, geminiModelsRes] = await Promise.all([
      ...
      const [openRouterData, geminiData] = await Promise.all([
        openRouterModelsRes.json(),
        geminiModelsRes.json(),
      ]);
